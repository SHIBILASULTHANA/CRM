    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usertype', models.CharField(choices=[('Employee', 'Employee'), ('Client', 'Client')], default='Administrator', max_length=128)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('salutation', models.CharField(blank=True, choices=[('MR', 'Mr.'), ('MRS', 'Mrs.'), ('MISS', 'Miss'), ('DR', 'Dr.')], max_length=5, null=True)),
                ...
                ('office_phone_number', models.BigIntegerField(validators=[django.core.validators.MaxValueValidator(9999999999), django.core.validators.MinValueValidator(1000000000)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile', models.BigIntegerField(validators=[django.core.validators.MaxValueValidator(9999999999), django.core.validators.MinValueValidator(1000000000)])),
                ('status', models.CharField(choices=[('Active', 'Active'), ('Inactive', 'Inactive')], default='----', max_length=20)),
